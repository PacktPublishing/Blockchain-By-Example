...
*/
  ...
  render() {
    // SimpleStorage Vars
  /*  var storedData ="dd" //this.props.drizzleStatus.initialized ? this.contracts.SimpleStorage.methods.storedData.data() : 'Loading...'
    ...
    var tokenBalance = "dd"//this.props.drizzleStatus.initialized ? this.contracts.TutorialToken.methods.balanceOf.data(this.props.accounts[0]) : 'Loading...'
*/
    return(

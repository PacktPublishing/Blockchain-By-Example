...
unlocked to sign the Readercoin-Qt.app bundle.
...
allowing somebody to distribute a Readercoin-Qt.app or readercoin-qt-setup.exe with a valid
...
that the readercoin-qt.exe file inside the installer had not been tampered with.

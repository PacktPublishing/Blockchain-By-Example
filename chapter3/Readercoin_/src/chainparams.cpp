...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x000001a9bbae8bb141c6941838bdacdbcf474b6ed28a0b18b2120b60a68f00ee");
        consensus.BIP65Height = 0; // 000000000000000004c2b624ed5d7756c508d90fd0da2c7c679febfa6c4735f0
        consensus.BIP66Height = 0; // 00000000000000000379eaa19dce8c9b722d46ae6a57c2f1a988119488b50931
       // consensus.powLimit = uint256S("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
	consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");                
	consensus.nPowTargetTimespan =24*60*60; // one day
        consensus.nPowTargetSpacing = 2.5 * 60; // 10 minutes
	...
	genesis = CreateGenesisBlock(1529321830, 490987, 0x1e0ffff0, 1, 10 * COIN);
       ...
       // assert(consensus.hashGenesisBlock == uint256S("0x000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f"));
        assert(consensus.hashGenesisBlock == uint256S("0x000001a9bbae8bb141c6941838bdacdbcf474b6ed28a0b18b2120b60a68f00ee"));
...
*/
        ...
        chainTxData = ChainTxData{
            ...
            1529321830, // * UNIX timestamp of last known number of transactions

...
#ifndef READERCOIN_QT_READERCOINUNITS_H
#define READERCOIN_QT_READERCOINUNITS_H
...
/** Readercoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ReadercoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ReadercoinUnits(QObject *parent);

    /** Readercoin units.
      @note Source: https://en.readercoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        RDC,
...
typedef ReadercoinUnits::Unit ReadercoinUnit;

#endif // READERCOIN_QT_READERCOINUNITS_H

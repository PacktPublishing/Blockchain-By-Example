...
#ifndef READERCOIN_WALLET_WALLET_H
#define READERCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this readercoin node, and set to 0 for transactions that were created
...
#endif // READERCOIN_WALLET_WALLET_H

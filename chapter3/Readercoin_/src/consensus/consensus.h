...
#ifndef READERCOIN_CONSENSUS_CONSENSUS_H
#define READERCOIN_CONSENSUS_CONSENSUS_H
...
static const int WITNESS_SCALE_FACTOR = 8;
...
#endif // READERCOIN_CONSENSUS_CONSENSUS_H

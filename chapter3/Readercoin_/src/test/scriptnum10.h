...
#ifndef READERCOIN_TEST_SCRIPTNUM10_H
#define READERCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Readercoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // READERCOIN_TEST_BIGNUM_H

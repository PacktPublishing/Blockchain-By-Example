...
This document provides guidelines for internationalization of the Readercoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `readercoin_en.ts` remains unchanged.

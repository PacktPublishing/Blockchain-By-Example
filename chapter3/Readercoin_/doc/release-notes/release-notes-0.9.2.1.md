Readercoin Core version 0.9.2.1 is now available from:

  https://readercoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 RDC to 0.01 RDC
...
- Fix "Start readercoin on system login"

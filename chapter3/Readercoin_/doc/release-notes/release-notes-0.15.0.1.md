Readercoin Core version *0.15.0.1* is now available from:

  <https://readercoin.org/bin/readercoin-core-0.15.0.1/>

and

  <https://readercoincore.org/bin/readercoin-core-0.15.0.1/>

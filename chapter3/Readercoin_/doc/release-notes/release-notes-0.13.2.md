Readercoin Core version 0.13.2 is now available from:

  <https://readercoin.org/bin/readercoin-core-0.13.2/>
...
- #8908 `4a974b2` Update readercoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow readercoin-tx to create v2 transactions (rdcdrak)

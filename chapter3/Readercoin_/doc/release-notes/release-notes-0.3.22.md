Download URL: https://sourceforge.net/projects/readercoin/files/Readercoin/readercoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 RDC fee schedule (users still pay 0.01 RDC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #readercoin00 - #readercoin99

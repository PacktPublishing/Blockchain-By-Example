Readercoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/readercoin/files/Readercoin/readercoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Readercoin
...
New/changed settings (command-line or readercoin.conf file)
--------------------------------------------------------

Readercoin Core version 0.10.4 is now available from:

  <https://readercoin.org/bin/readercoin-core-0.10.4/>
...
- #6953 `43c2789` Split readercoin-tx into its own package
- #6953 `dfe0d4d` Include readercoin-tx binary on Debian/Ubuntu

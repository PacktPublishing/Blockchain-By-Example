Readercoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/readercoin/files/Readercoin/readercoin-0.5.4/
...
http://gitorious.org/readercoin/readercoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Readercoin-Qt notifications under Growl 1.3.
Increase required age of Readercoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxReadercoin properly when installing Readercoin-Qt over it. (Windows)

Readercoin Core version 0.9.4 is now available from:

  https://readercoin.org/bin/0.9.4/
...
this update is incompatible with the Readercoin system and could lead to consensus
forks.

Readercoin Core released binaries from https://readercoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~readercoin/+archive/ubuntu/readercoin
- A third-party or self-compiled Readercoin Core

upgrade to Readercoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

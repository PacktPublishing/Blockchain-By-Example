...
# TestNode: A peer we use to send messages to readercoind, and store responses.
...
class CompactBlocksTest(ReadercoinTestFramework):
    ...
    # This test actually causes readercoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that readercoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for readercoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # readercoind will not send blocktxn responses for blocks whose height is

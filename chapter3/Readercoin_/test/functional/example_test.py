...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ReadercoinTestFramework
    pass

class ExampleTest(ReadercoinTestFramework):
    # Each functional test is a subclass of the ReadercoinTestFramework class.
    ...
    def custom_method(self):
        ...
        ReadercoinTestFramework class so other tests can use it."""

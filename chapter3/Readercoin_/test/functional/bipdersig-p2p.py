...
class BIP66Test(ReadercoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # readercoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and readercoind produces more specific reject
            # reasons.
